<script lang="ts">
	...
	const tollingServices: Service[] = [
		...
		{
			name: 'Transformation',
			description: `Maybe a primal is too much to handle; maybe you want something that's already cut up. That's where Transformation comes in.`,
			subservice: [
				{
					name: 'Cutting',
